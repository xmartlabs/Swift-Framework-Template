...
We do not use github issues for general library support. We think this questions should be posted on stack overflow using [XLProductName](http://http://stackoverflow.com/questions/tagged/XLProductName) tag.

### Reporting issues

* Use [github issues](https://github.com/XLUserName/XLProductName/issues) to report a bug.
* Before creating a new issue:
  * Make sure you are using the [latest release](https://github.com/XLUserName/XLProductName/releases).
...
2. Clone your forked project into your developer machine: `git clone git@github.com:<your-github-username>/XLProductName.git`
3. Add the original project repo as upstream repository in your forked project: `git remote add upstream git@github.com:XLUserName/XLProductName.git`
